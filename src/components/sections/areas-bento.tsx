...
const areas = [
    {
        Icon: BookOpenIcon,
        name: "Ensino",
        description: "Grupos de estudos e formação teórica em TCC baseada em evidências científicas.",
        href: "#quem-somos",
        cta: "Saiba mais",
    ...
    },
    {
        Icon: SearchIcon,
        name: "Pesquisa",
        description: "Investigação científica e produção acadêmica no contexto universitário da USP.",
        href: "#quem-somos",
        cta: "Saiba mais",
    ...
    },
    {
        Icon: UsersIcon,
        name: "Extensão",
        description: "Ações práticas e difusão do conhecimento em saúde mental para a comunidade.",
        href: "#quem-somos",
        cta: "Saiba mais",
    ...
    },
    {
        Icon: CalendarIcon,
        name: "Eventos",
        description: "Organização de palestras, jornadas acadêmicas e minicursos científicos.",
        href: "#contato",
    ...
    },
    {
        Icon: Share2Icon,
        name: "Marketing",
        description: "Divulgação científica, gestão da marca e presença em mídias sociais.",
    ...
    },
    {
        Icon: BuildingIcon,
        name: "Administração",
        description: "Gestão institucional, governança, planejamento estratégico e suporte operacional da Liga.",
        href: "#quem-somos",
        cta: "Saiba mais",
        background: <div className="absolute -left-10 -bottom-10 w-80 h-80 bg-gradient-to-tr from-[#08607e]/20 via-[#56035c]/15 to-transparent blur-3xl rounded-full transform-gpu transition-all duration-500 group-hover:scale-110" />,
